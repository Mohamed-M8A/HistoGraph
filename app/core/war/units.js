...
// unit instances, and parsing and interpreting a tick-based
// scripting language that drives all of the above. This file has
// no notion of "game rules" — it is a dumb executor of explicit
// commands (SPAWN/MOV/DEL/RM/FADE/ATK), same as effects.js is a
// dumb factory for weapon effects. Any game-layer logic (AI,
// player restrictions, victory conditions) belongs outside this
// file and simply emits the same script syntax this file already
// understands. This module never touches the DOM, Canvas, or any
// browser-only rendering API; painting units onto a canvas is the
// responsibility of renderer/units.js.
//
// TABLE OF CONTENTS
